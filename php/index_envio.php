            ...
            <table id="table_master" class="table display" style="width:100%">
                ...
                <?php
                    if (isset($_POST['datainicio'])) {
                        echo  $interaction->SearchRelatorioEnvio($setor, $busca, $datainicial, $datafinal);
                    } else {
                        echo  $interaction->SearchRelatorioEnvio('all', '', date('Y-m-d'), date('Y-m-d'));
                    }
                    ?>
